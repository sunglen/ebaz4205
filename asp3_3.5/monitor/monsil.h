 ...
 * 
 *  @(#) $Id: monsil.h,v 1.7 2004/09/26 16:32:20 roi Exp $
 */
...
sil_reb_mem(VP mem)
{
    ...
    MemoryRead((unsigned long)mem, (void *)&data, sizeof(VB));
	ana_rdv((UW)mem, (UW)data, 1);
	return(data);
}
...
{
	ana_wdv((UW)mem, (UW)data, 1);
    MemoryWrite((unsigned long)mem, (void *)&data, sizeof(VB));
}
...
sil_reh_mem(VP mem)
{
    ...
    MemoryRead((unsigned long)mem,  (void *)&data, sizeof(VH));
	ana_rdv((UW)mem, (UW)data, 2);
	return(data);
}
...
{
	ana_wdv((UW)mem, (UW)data, 2);
    MemoryWrite((unsigned long)mem, (void *)&data, sizeof(VH));
}
...
sil_rew_mem(VP mem)
{
    ...
    MemoryRead((unsigned long)mem, (void *)&data,  sizeof(VW));
	ana_rdv((UW)mem, (UW)data, 4);
	return(data);
}
...
{
	ana_wdv((UW)mem, (UW)data, 4);
    MemoryWrite((unsigned long)mem, (void *)&data, sizeof(VW));
}
