 ...
 * 
 *  @(#) $Id: monitor.c,v 2.2 2019/01/21 18:01:45 roi Exp $
 */
...
static int_t   task_terminate_in_mon(int argc, char **argv);
...
"ASP TASK Monitor Release %d.%d.%d for %s"
" (" __DATE__ ", " __TIME__ ")\n"
...
static const COMMAND_INFO task_command_info[] = {
	...
	{"TERMINATE",	task_terminate_in_mon},
 ...
 */
static int_t
task_terminate_in_mon(int argc, char **argv)
{
	ER      ercd = E_OK;
