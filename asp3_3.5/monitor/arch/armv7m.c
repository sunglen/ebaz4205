 ...
 * 
 *  @(#) $Id: armv7.c,v 1.5 2019/03/08 18:03:21 roi Exp $
 */
...
static T_MEMDEF const memdefine[] = {
	...
	{0x40000000, 0x50060FFF,           PORT_AREA,   MREAD_WRITE},
	{0xA0000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(TOPPERS_STM32G071_NUCLEO64)	/* ARMV6m */
	{0x08000000, 0x0801FFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x20000000, 0x20008FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x50060FFF,           PORT_AREA,   MREAD_WRITE},
	{0xA0000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
...
#elif defined(TOPPERS_STM32L4R5_NUCLEO144)
	{0x08000000, 0x080FFFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x10000000, 0x10007FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x20000000, 0x2009FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x6FFFFFFF,           PORT_AREA,   MREAD_WRITE},
	{0x80000000, 0xBFFFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(TOPPERS_STM32F4_DISCOVERY) || defined(TOPPERS_STM32_E407) || defined(TOPPERS_STM32F4_YSPRO) || defined(TOPPERS_STM32F4_IMT407G)
	{0x08000000, 0x080FFFFF,           MEMORY_AREA, MREAD_ONLY },
	...
	{0x10000000, 0x1FFFFFFF,           PORT_AREA,   MREAD_WRITE},
	{0x20000000, 0x2000FFFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x5007FFFF,           PORT_AREA,   MREAD_WRITE},
	{0xF0000000, 0xF1FFFFFF,           PORT_AREA,   MREAD_WRITE},
#elif defined(NRF52810)
	{0x00000000, 0x0002FFFF,           MEMORY_AREA, MREAD_ONLY },
	{0x10000000, 0x1FFFFFFF,           PORT_AREA,   MREAD_WRITE},
	{0x20000000, 0x20005FFF,           MEMORY_AREA, MREAD_WRITE},
	{0x40000000, 0x5007FFFF,           PORT_AREA,   MREAD_WRITE},
	{0xF0000000, 0xF1FFFFFF,           PORT_AREA,   MREAD_WRITE},
#else
