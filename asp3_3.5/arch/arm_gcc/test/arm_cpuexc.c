 ...
 *  の責任を負わない．
 * 
 *  $Id: arm_cpuexc.c 1276 2019-10-03 16:15:55Z ertl-hiro $
 */
 ...
 *	(3-B) CPU例外ハンドラにおいて，xsns_dpnがfalseを返すこと
 *
 * 【使用リソース】
 *
 ...
 *	== CPUEXC5 ==
 *	50:	state(true, true, false, true, false)				... (A)
 *		assert(xsns_dpn(p_excinf) == true)					... (B)
 *	51:	END
 */
