 ...
 *  の責任を負わない．
 * 
 *  $Id: interrupt.c 752 2020-01-17 12:49:12Z ertl-hiro $
 */
...
dis_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2, get_mydom());	/*［NGKI3084］*/
...
ena_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2, get_mydom());	/*［NGKI3097］*/
...
clr_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2, get_mydom());	/*［NGKI3922］*/
...
ras_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn2, get_mydom());	/*［NGKI3934］*/
...
prb_int(INTNO intno)
{
	...
	CHECK_ACPTN(sysstat_acvct.acptn4, get_mydom());	/*［NGKI3946］*/
...
chg_ipm(PRI intpri)
{
	...
	CHECK_TSKCTX_UNL_MYSTATE(&p_selftsk, &selfdom);	/*［NGKI3108］［NGKI3109］*/
	CHECK_PAR(VALID_INTPRI_CHGIPM(intpri));		/*［NGKI3113］［NGKI3114］*/
	CHECK_ACPTN(sysstat_acvct.acptn2, selfdom);	/*［NGKI3110］*/
...
get_ipm(PRI *p_intpri)
{
	...
	CHECK_TSKCTX_UNL_MYSTATE(&p_selftsk, &selfdom);	/*［NGKI3116］［NGKI3117］*/
	CHECK_MACV_WRITE(p_intpri, PRI, p_selftsk, selfdom);	/*［NGKI3119］*/
	CHECK_ACPTN(sysstat_acvct.acptn4, selfdom);	/*［NGKI3118］*/
