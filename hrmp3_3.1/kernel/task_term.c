 ...
 *  の責任を負わない．
 * 
 *  $Id: task_term.c 690 2019-12-25 04:45:22Z ertl-hiro $
 */
...
ras_ter(ID tskid)
{
	...
	CHECK_TSKCTX_UNL_MYSTATE(&p_selftsk, &selfdom);	/*［NGKI3470］［NGKI3471］*/
	CHECK_ID(VALID_TSKID(tskid));					/*［NGKI3472］*/
	p_tcb = get_tcb(tskid);
	CHECK_ILUSE(p_tcb != p_selftsk);				/*［NGKI3475］*/
	CHECK_ACPTN(p_tcb->p_tinib->acvct.acptn2, selfdom);	/*［NGKI3474］*/
...
dis_ter(void)
{
	...
	LOG_DIS_TER_ENTER();
	CHECK_TSKCTX_UNL_MYSTATE(&p_selftsk, &selfdom);	/*［NGKI3483］［NGKI3484］*/
	CHECK_ACPTN(p_selftsk->p_dominib->acvct.acptn2, selfdom);	/*［NGKI3764］*/
...
ena_ter(void)
{
	...
	LOG_ENA_TER_ENTER();
	CHECK_TSKCTX_UNL_MYSTATE(&p_selftsk, &selfdom);	/*［NGKI3488］［NGKI3489］*/
	CHECK_ACPTN(p_selftsk->p_dominib->acvct.acptn2, selfdom);	/*［NGKI3765］*/
...
ter_tsk(ID tskid)
{
	...
	CHECK_TSKCTX_UNL_MYSTATE(&p_selftsk, &selfdom);	/*［NGKI1171］［NGKI1172］*/
	CHECK_ID(VALID_TSKID(tskid));				/*［NGKI1173］*/
	p_tcb = get_tcb(tskid);
	CHECK_ACPTN(p_tcb->p_tinib->acvct.acptn3, selfdom);	/*［NGKI3508］*/
