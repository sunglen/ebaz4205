 ...
 *  の責任を負わない．
 * 
 *  $Id: task.h 726 2020-01-01 23:53:44Z ertl-hiro $
 */
 ...
 *  タスク管理ブロック（TCB）
 *
 *  HRMP3カーネルでは，タスクの起動要求キューイング数の最大値（TMAX_ACTCNT）
 ...
 */
extern void update_my_schedtsk(PCB *p_my_pcb);
extern void update_schedtsk(PCB *p_my_pcb, PCB *p_pcb);
 ...
 *  な場合には，実行すべきタスクを更新する．
 */
extern void	rotate_ready_queue(PCB *p_my_pcb, uint_t pri,
									SCHEDCB *p_schedcb, PCB *p_pcb);
