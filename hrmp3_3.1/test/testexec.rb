...
#  の責任を負わない．
# 
#  $Id: testexec.rb 750 2020-01-17 12:38:58Z ertl-hiro $
# 
...
TEST_SPEC = {
  ...
  "mtskman4" => { SRC: "test_mtskman4" },
  "mtrans1"  => { SRC: "test_mtrans1" },
  ...
  "malarm2"  => { SRC: "test_malarm2" },
  "mdelay1"  => { SRC: "test_mdelay1" },
  ...
  "perf0u" => { SRC: "perf0", CFG: "perf0u",
						CDL: "perf_pf", SYSLIB: "histogram" },
  "perf1u" => { SRC: "perf1", CFG: "perf1u",
						CDL: "perf_pf", SYSLIB: "histogram" },
