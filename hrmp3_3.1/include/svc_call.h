...
extern ER _kernel_ref_spn(ID spnid, T_RSPN *pk_rspn) throw();
extern ER _kernel_mact_tsk(ID tskid, ID prcid) throw();
extern ER _kernel_mig_tsk(ID tskid, ID prcid) throw();
#ifdef TOPPERS_SUPPORT_SUBPRIO
extern ER _kernel_chg_spr(ID tskid, uint_t subpri) throw();
#endif /* TOPPERS_SUPPORT_SUBPRIO */
extern ER _kernel_msta_cyc(ID cycid, ID prcid) throw();
extern ER _kernel_msta_alm(ID almid, RELTIM almtim, ID prcid) throw();
...
extern ER _kernel_get_pid(ID *p_prcid) throw();
extern ER _kernel_mget_nth(ID schedno, PRI tskpri, uint_t nth, ID *p_tskid) throw();
extern ER _kernel_loc_spn(ID spnid) throw();
extern ER _kernel_try_spn(ID spnid) throw();
extern ER _kernel_unl_spn(ID spnid) throw();
...
#define ref_spn _kernel_ref_spn
#define mact_tsk _kernel_mact_tsk
#define mig_tsk _kernel_mig_tsk
#ifdef TOPPERS_SUPPORT_SUBPRIO
#define chg_spr _kernel_chg_spr
#endif /* TOPPERS_SUPPORT_SUBPRIO */
#define msta_cyc _kernel_msta_cyc
#define msta_alm _kernel_msta_alm
#define mrot_rdq _kernel_mrot_rdq
#define mget_lod _kernel_mget_lod
#define get_pid _kernel_get_pid
#define mget_nth _kernel_mget_nth
#define loc_spn _kernel_loc_spn
#define try_spn _kernel_try_spn
#define unl_spn _kernel_unl_spn
