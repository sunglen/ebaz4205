...
void *const _kernel_memtop_table[17] = {
	...
	__start_mo_text_DOM1 /* 0x0100d000 */,
	__start_mo_text_shared /* 0x0100e000 */,
	__aend_mo_text_shared /* 0x0100f000 */,
	__start_mo_rwdata_kernel /* 0x01800000 */,
	__start_ustack_TASK1 /* 0x01807000 */,
	__start_ustack_TOPPERS_RAM_DUMMY1 /* 0x01808000 */,
	__start_ustack_TASK2 /* 0x01809000 */,
	__start_mo_rwdata_DOM1 /* 0x0180a000 */,
	__start_mo_rwdata_DOM1_S_1_S /* 0x0180c000 */,
	__aend_mo_rwdata_DOM1_S_1_S /* 0x0180d000 */,
...
const MEMINIB _kernel_meminib_table[17] = {
	...
	{ TA_USTACK|(TA_NOINITSEC), TACP(DOM1), TACP(DOM1), TACP_SHARED },
