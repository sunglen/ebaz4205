...
#{nest_str}      accessPattern1 = C_EXP( "TACP(#{@start_region.get_domain_root.get_name})|TACP(#{@end_region.get_domain_root.get_name})" );
#{nest_str}      accessPattern2 = C_EXP( "TACP(#{@start_region.get_domain_root.get_name})|TACP(#{@end_region.get_domain_root.get_name})" );
#{nest_str}      accessPattern3 = C_EXP( "TACP(#{@start_region.get_domain_root.get_name})|TACP(#{@end_region.get_domain_root.get_name})" );
#{nest_str}      accessPattern4 = C_EXP( "TACP(#{@start_region.get_domain_root.get_name})|TACP(#{@end_region.get_domain_root.get_name})" );
#{nest_str}  };
EOT
    file.print <<EOT
